...
- **20–25** far-end devices ABSENT (audit gap #4): their I2C engines (I2C1/3/4/5/6) are not even enabled in the DTS yet (only I2C2/i2c-1 is). Each needs bus-enable + node + model + validation. D08-devices (task #135).
