...
- **16** W83795 model silicon-seeded (fan1=2641 etc.); hwmon both sides. D08. **ZQ 🔶→✅
  ...
  with row 42 PECI's "not complete functionality → 🔶"); #183 now scoped to SmartFan+alarm only. NOTE (new
  Linux gap #184): the modern-hwmon w83795 driver patch (0003) exposes only in/fan/temp — NOT intrusion0_alarm
  / cpu0_vid — so the CASEOPEN/VID *userspace* attrs aren't surfaced (the model is right; the driver drops
  them). **23** SB-TSI ZQ 🔶→✅ (2026-07-20):
