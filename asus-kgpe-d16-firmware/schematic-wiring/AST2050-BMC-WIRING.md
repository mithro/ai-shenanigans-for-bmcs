...
| Board FRU EEPROM | `U25` | Holtek **HT24LC08** (8 Kbit) | **I2C5** (A13/B13) | **`0x54`–`0x57`** (A2/E2=VCC strap; unstrapped base is `0x50`–`0x53`, +2-bit block in cmd) | I²C EEPROM (16-byte page write) | Direct on I2C5. **Silicon i2c-scan 2026-07-20 (device-driver-program evidence d14-zephyr/16): ACK 0x54–0x57, NAK 0x50–0x53** — the 24C08's A2 pin is strapped high, so it presents at the upper quartet, not the 0x50 base. |
