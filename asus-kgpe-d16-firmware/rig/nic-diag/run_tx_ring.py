...
# dependencies = []
# ///
"""Push tmp/tx_ring_host.py to the host and run it (TX descriptor ring dump)."""
import subprocess, base64, sys, os
PI, HOST = "asus-bmc", "192.168.77.138"
SOPT = "-o StrictHostKeyChecking=" + "no"
HERE = os.path.dirname(os.path.abspath(__file__))
b64 = base64.b64encode(open(os.path.join(HERE, "tx_ring_host.py"), "rb").read()).decode()
...
hostrun(f"echo {b64} | base64 -d > /root/tx_ring_host.py")
r = hostrun("python3 /root/tx_ring_host.py")
