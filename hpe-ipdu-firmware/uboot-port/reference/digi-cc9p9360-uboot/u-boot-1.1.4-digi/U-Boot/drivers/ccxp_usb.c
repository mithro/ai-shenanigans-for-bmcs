...
/***********************************************************************
 *  @History:
 *	2005/09/13 : initial version (Bernd Westermann)
 ***********************************************************************/
#include <common.h>
#include <asm-arm/byteorder.h>
#ifdef CONFIG_USB_CCXP
#include <usb.h>
#include "sl811.h"

#define	 SL811_ADR (0x31C00000)
#define	 SL811_DAT (0x31C00004)
