...
/*****  SMDK2410 ********************************************************/
#elif defined(CONFIG_SMDK2410_LED)
# undef STATUS_LED_PAR
# undef STATUS_LED_DIR
# undef STATUS_LED_ODR
# undef STATUS_LED_DAT

# define STATUS_LED_BIT		0x0040		/* LED at GPF.6 used */
# define STATUS_LED_PERIOD	(CFG_HZ / 2)
...
# endif
# define STATUS_LED_BOOT	0		/* LED 0 of CONFIG_STATUS_LED used for boot status */

/*****  CC9C *************************************************************/
#elif defined(CONFIG_CC9C_LED)
# define STATUS_LED_BIT		67		/* LED at GPIO67 used */
...
/* XXX empty just to avoid the error */
/************************************************************************/
#elif defined(CONFIG_UNC90)
/* UNC90 led configuration is done in configs/unc90.h */
#else
