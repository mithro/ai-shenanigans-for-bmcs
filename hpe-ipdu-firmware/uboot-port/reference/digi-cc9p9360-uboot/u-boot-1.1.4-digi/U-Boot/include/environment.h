...
#ifdef CFG_DIGI_ENVIRONMENT
/* Data structure first block */
typedef struct fb {
	unsigned long	crc;		/* CRC32 over type, tag and version	*/

	unsigned char	tag;		/* tag = 0x15 */
	unsigned char	type;		/* type = 0x00 */
	int		version;
} Fb_t;

/* Data structure header */
typedef struct header {
	unsigned long	crc;		/* CRC32 over type and version	*/
...
typedef struct digi_environment {
	Fb_t		fsb;
	Header_t	envheader;
	Block_t		envblock;
} Digi_env_t;
#endif	/* CFG_DIGI_ENVIRONMENT */
