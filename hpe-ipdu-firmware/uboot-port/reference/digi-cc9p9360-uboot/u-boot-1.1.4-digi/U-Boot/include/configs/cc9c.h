...
#define CPU			"NS9360"
#define CONFIG_MACH_CC9CJS		/* Select board mach-type */
...
#define EBOOTFLADDR		"180000"
#define WCEFLADDR		"200000"
#define CONFIG_BOOTFILE		"uImage-cc9cjsnand"
#else
#define CFG_FLASH_CFI		/* The flash is CFI compatible	*/
#define CFG_FLASH_CFI_DRIVER	/* Use common CFI driver	*/
#define PLATFORM		"nor"
#define EBOOTFLADDR		"50050000"
#define WCEFLADDR		"50100000"
#define CONFIG_BOOTFILE		"uImage-cc9cjsnor"
...
#define CONFIG_EXTRA_ENV_SETTINGS			\
	...
	"uimg=u-boot-cc9cjs"PLATFORM".bin\0"		\
	"rimg=rootfs-cc9cjs"PLATFORM".jffs2\0"		\
	"kimg=uImage-cc9cjs"PLATFORM"\0"		\
	"eimg=eboot-cc9x\0"			\
	"wimg=wce-cc9x\0"			\
	"loadaddr=200000\0"				\
	...
	"npath=/exports/nfsroot-cc9cjs"PLATFORM"\0"	\
	"smtd=setenv bootargs ${std_bootarg} ip=${ipaddr}:${serverip}::${netmask}:9360:eth0:off root=/dev/mtdblock3 rootfstype=jffs2\0"	\
...
#endif
#define MODULE_STRING		"ConnectCore9C"
...
#define BOARD_TEST_SDRAM_START          0x00400000
#define BOARD_TEST_SDRAM_SIZE           0x00800000
...
#define CONFIG_NR_NAND_PART	4	/* 4 partitions in NAND Flash */
#define NAND_NAME_0	"u-boot"
#define NAND_START_0	0x00000000
#define NAND_SIZE_0	0x00100000
#define NAND_NAME_1	"environment"
#define NAND_START_1	0x00100000
#define NAND_SIZE_1	0x00080000	/* place for duplicate sector and bad blocks */
#define NAND_NAME_2	"kernel"
#define NAND_START_2	0x00180000
#define NAND_SIZE_2	0x00300000
#define NAND_NAME_3	"rootfs"
#define NAND_START_3	0x00480000
#define NAND_SIZE_3	0x01B80000	/* size of last partition will be calculated */

#define CONFIG_JFFS2_NAND
#define CONFIG_JFFS2_NAND_OFF	0x00480000
#define CONFIG_JFFS2_NAND_SIZE	0x01B80000
...
#define MTDIDS_DEFAULT		"nand0=CC9C-0"
#define MTDPARTS_DEFAULT	"mtdparts=CC9C-0:1m@0(u-boot)ro,"	\
						"512k@1m(environment),"	\
						"3m@1536k(kernel),"		\
						"-@4608k(rootfs)ro"
*/
