 ...
 * All rights reserved.
 *
 * $Id: ns9750_sys.h,v 1.5 2005/01/27 10:55:53 jdietsch Exp $
...
#define NS9750_SYS_RTC_CTRL_BASE	(0x0224)
...
/* CS_DYN index 0..3 */
#define NS9750_SYS_CS_DYN_BASE(c)	(NS9750_SYS_CS_DYN_BASE_BASE + (c)*8)
#define NS9750_SYS_CS_DYN_MASK(c)	(NS9750_SYS_CS_DYN_MASK_BASE + (c)*8)
/* CS_STATIC start with 0 */
#define NS9750_SYS_CS_STATIC_BASE(c)	(NS9750_SYS_CS_STATIC_BASE_BASE + (c)*8)
#define NS9750_SYS_CS_STATIC_MASK(c)	(NS9750_SYS_CS_STATIC_MASK_BASE + (c)*8)
#define NS9750_SYS_EXT_INT_CTRL(c)	(NS9750_SYS_EXT_INT_CTRL_BASE + (c)*4)
...
#define NS9750_SYS_CLOCK_RTC		(0x00000800)
