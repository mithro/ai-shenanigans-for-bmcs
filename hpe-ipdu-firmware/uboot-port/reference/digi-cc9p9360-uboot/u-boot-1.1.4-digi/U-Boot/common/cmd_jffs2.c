...
# if !defined(CONFIG_A9M2410) && !defined(CONFIG_A9M9360) && !defined(CONFIG_A9M9750) && !defined(CONFIG_CC9C) && !defined(CONFIG_CCW9C)
		part->size = CONFIG_JFFS2_PART_SIZE;
# else
#  if defined(CONFIG_CC9C)
		part->size = gd->bd->bi_nand[3].size;
#  elif defined(CONFIG_CCW9C)
		part->size = gd->bd->bi_nand[4].size;
#  else
		part->size = gd->bd->bi_nand[2].size;
#  endif
# endif
