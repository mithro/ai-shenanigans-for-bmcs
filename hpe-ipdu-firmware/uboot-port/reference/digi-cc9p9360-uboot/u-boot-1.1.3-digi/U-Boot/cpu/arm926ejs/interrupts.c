...
#define READ_TIMER (*(volatile ulong *)(CFG_TIMERBASE+4))
#endif
#if defined (CONFIG_NS9750) || (CONFIG_NS9360)
# include <ns9750_sys.h>
# define TIMER_USED	(0)
# define READ_TIMER	*get_sys_reg_addr(NS9750_SYS_TIMER_READ(TIMER_USED))
#endif
...
#if defined (CONFIG_NS9750) || (CONFIG_NS9360)
		*get_sys_reg_addr( NS9750_SYS_TIMER_COUNT( TIMER_USED ) )=TIMER_LOAD_VAL;
		*get_sys_reg_addr( NS9750_SYS_TIMER_CTRL( TIMER_USED ) ) =
		 					NS9750_SYS_TIMER_CTRL_TEN | 
							NS9750_SYS_TIMER_CTRL_TLCS_64 |
							NS9750_SYS_TIMER_CTRL_UDS | 
							NS9750_SYS_TIMER_CTRL_TSZ |
							NS9750_SYS_TIMER_CTRL_REN;
#endif /* (CONFIG_NS9750) || (CONFIG_NS9360) */
