...
/***********************************************************************
 *  @History:
 *	2005/09/25 : CCXP270, cleanup (Bernd Westermann)
 ***********************************************************************/
...
#define CFG_CMD_CHGMAC	0x0000080000000000ULL	/* change MAC address in eeprom	*/
...
#define CFG_CMD_CLOCK	0x4000000000000000ULL	/* set clock speed on CCXP270	*/
#define CFG_CMD_VCCCORE	0x8000000000000000ULL	/* set VCC CORE Voltage on CCXP270	*/
